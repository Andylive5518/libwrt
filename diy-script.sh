...
# 添加额外插件
# git clone --depth=1 https://github.com/kongfl888/luci-app-adguardhome package/new/luci-app-adguardhome
# git clone --depth=1 -b master https://github.com/tty228/luci-app-wechatpush package/new/luci-app-serverchan
...
# 科学上网插件
git clone --depth=1 -b master https://github.com/fw876/helloworld package/emortal/luci-app-ssr-plus
# git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall-packages package/new/openwrt-passwall
# git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall package/new/luci-app-passwall
# git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall2 package/new/luci-app-passwall2
#git_sparse_clone master https://github.com/vernesong/OpenClash luci-app-openclash
git clone --depth=1 https://github.com/nikkinikki-org/OpenWrt-nikki package/emortal/luci-app-nikki

# Themes
# git clone --depth=1 https://github.com/kiddin9/luci-theme-edge package/new/luci-theme-edge
git clone --depth=1 https://github.com/jerrykuku/luci-theme-argon package/emortal/luci-theme-argon
git clone --depth=1 https://github.com/jerrykuku/luci-app-argon-config package/emortal/luci-app-argon-config
...
# msd_lite
# git clone --depth=1 https://github.com/ximiTech/luci-app-msd_lite package/new/luci-app-msd_lite
